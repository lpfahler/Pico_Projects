...
# LBP - LED setup
red2LED = machine.Pin(20, machine.Pin.OUT)
red1LED = machine.Pin(19, machine.Pin.OUT)
blue0LED = machine.Pin(18, machine.Pin.OUT)
green1LED = machine.Pin(17, machine.Pin.OUT)
green2LED = machine.Pin(16, machine.Pin.OUT)
...
def time_to_matrix():
    ...
    # LBP: find the delta
    deltaMinute = actualMinute - minute
    # LBP: display deltaMinute
    print(actualMinute, deltaMinute)
    
    # LBP: light LEDS according to deltaMinute value
    if deltaMinute == -2:
        red2LED.value(1)
        red1LED.value(0)
        blue0LED.value(0)
