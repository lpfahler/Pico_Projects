# Data from Photoresitor on 4-Digit, 7-Segment Display
...
try:
    while True:
        ...
        light_value = round(photoresist.read_u16() / 65535 * 100, 2)
        print(f'{light_value}%')
        display_number(light_value, pov_time_us = 1000, display_time_ms = 2000)
