...
# Display some nice graphics - music note, tree, house
# Common Anode "788BS"
...
try:
    while True:
        # music note
        display_graphic(note, pov_time_us = 1000, display_time_ms = 1000)
        
        # tree
        display_graphic(tree, pov_time_us = 1000, display_time_ms = 1000)
                
        # house
        display_graphic(house, pov_time_us = 1000, display_time_ms = 1000)
