# Program to play the songs on a passive buzzer
# April 2023
# Lori Pfahler
...
try:
    # playsong(buzzer, songs.starWars, tempo = 1500)          
    # playsong(buzzer, songs.takeMeOn, tempo = 2000)
    # playsong(buzzer, songs.gameOfThrones, tempo = 2000)
    # playsong(buzzer, songs.starTrekIntro, tempo = 3000)
    # playsong(buzzer, songs.harryPotter, tempo = 1000)
    # playsong(buzzer, songs.margaritaville, tempo = 1500)
    playsong(buzzer, songs.odeToJoy, tempo = 1500)
